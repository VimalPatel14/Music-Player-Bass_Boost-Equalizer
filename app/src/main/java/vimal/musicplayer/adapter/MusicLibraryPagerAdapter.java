...
import vimal.musicplayer.ui.fragments.mainactivity.library.pager.GenresFragment;
...
public class MusicLibraryPagerAdapter extends FragmentPagerAdapter {
    ...
    public MusicLibraryPagerAdapter(@NonNull final Context context, final FragmentManager fragmentManager) {
        ...
        mContext = context;
        setCategoryInfos(Music_Player_Bass_PreferenceUtil.getInstance(context).getLibraryCategoryInfos());
    }

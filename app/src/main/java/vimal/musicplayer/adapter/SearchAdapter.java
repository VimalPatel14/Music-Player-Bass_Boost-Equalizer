    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case ALBUM:
                ...
                holder.text.setText(Music_Player_Bass_MusicUtil.getAlbumInfoString(activity, album));
            ...
            case SONG:
                ...
                holder.text.setText(Music_Player_Bass_MusicUtil.getSongInfoString(song));
                break;
            default:
    ...
    public class ViewHolder extends MediaEntryViewHolder {
        ...
        public void onClick(View view) {
            ...
            switch (getItemViewType()) {
                case ALBUM:
                    Music_Player_Bass_NavigationUtil.goToAlbum(activity,
                            ((Album) item).getId(),
                            Pair.create(image,
                    ...
                    break;
                case ARTIST:
                    Music_Player_Bass_NavigationUtil.goToArtist(activity,
                            ((Artist) item).getId(),
                            Pair.create(image,

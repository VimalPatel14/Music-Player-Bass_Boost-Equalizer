...
public class AlbumAdapter extends AbsMultiSelectAdapter<AlbumAdapter.ViewHolder, Album> implements FastScrollRecyclerView.SectionedAdapter {
    ...
    protected String getAlbumText(Album album) {
        return Music_Player_Bass_MusicUtil.buildInfoString(
            album.getArtistName(),
            Music_Player_Bass_MusicUtil.getSongCountString(activity, album.songs.size())
        );
    }
    ...
    public String getSectionName(int position) {
        ...
        switch (Music_Player_Bass_PreferenceUtil.getInstance(activity).getAlbumSortOrder()) {
            case Music_Player_Bass_SortOrder.AlbumSortOrder.ALBUM_A_Z:
            case Music_Player_Bass_SortOrder.AlbumSortOrder.ALBUM_Z_A:
                sectionName = dataSet.get(position).getTitle();
                break;
            case Music_Player_Bass_SortOrder.AlbumSortOrder.ALBUM_ARTIST:
                sectionName = dataSet.get(position).getArtistName();
                break;
            case Music_Player_Bass_SortOrder.AlbumSortOrder.ALBUM_YEAR:
                return Music_Player_Bass_MusicUtil.getYearString(dataSet.get(position).getYear());
        }
    ...
    public class ViewHolder extends MediaEntryViewHolder {
        ...
        public void onClick(View v) {
            if (isInQuickSelectMode()) {
                ...
                Music_Player_Bass_NavigationUtil.goToAlbum(activity, dataSet.get(getAdapterPosition()).getId(), albumPairs);
            }
        }

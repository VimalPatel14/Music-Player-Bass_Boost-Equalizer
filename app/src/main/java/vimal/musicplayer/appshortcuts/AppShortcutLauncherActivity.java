...
import vimal.musicplayer.appshortcuts.shortcuttype.LastAddedShortcutType;
import vimal.musicplayer.appshortcuts.shortcuttype.ShuffleAllShortcutType;
import vimal.musicplayer.appshortcuts.shortcuttype.TopTracksShortcutType;
...
import vimal.musicplayer.model.smartplaylist.Music_Player_Bass_ShuffleAllPlaylist;
import vimal.musicplayer.service.MusicService;



public class AppShortcutLauncherActivity extends Activity {
    public static final String KEY_SHORTCUT_TYPE = "photovideomusicstudio.GalleryPhotoMusicPlayer.appshortcuts.ShortcutType";
        ...
        switch (shortcutType) {
            case SHORTCUT_TYPE_SHUFFLE_ALL:
                startServiceWithPlaylist(MusicService.SHUFFLE_MODE_SHUFFLE,
                        new Music_Player_Bass_ShuffleAllPlaylist(getApplicationContext()));
            ...
            case SHORTCUT_TYPE_TOP_TRACKS:
                startServiceWithPlaylist(MusicService.SHUFFLE_MODE_NONE,
                        new Music_Player_Bass_MyTopTracksPlaylist(getApplicationContext()));

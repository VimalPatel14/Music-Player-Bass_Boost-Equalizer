package vimal.musicplayer.appshortcuts.shortcuttype;
...
import vimal.musicplayer.appshortcuts.AppShortcutLauncherActivity;


@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "photovideomusicstudio.GalleryPhotoMusicPlayer.appshortcuts.id.";

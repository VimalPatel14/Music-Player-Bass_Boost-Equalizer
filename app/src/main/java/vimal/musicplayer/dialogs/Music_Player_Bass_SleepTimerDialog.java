...
public class Music_Player_Bass_SleepTimerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        materialDialog = new MaterialDialog.Builder(getActivity())
                ...
                .onPositive((dialog, which) -> {
                    ...
                    Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setSleepTimerFinishMusic(shouldFinishLastSong.isChecked());
                    ...
                    Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setNextSleepTimerElapsedRealtime(nextSleepTimerElapsedTime);
        ...
        boolean finishMusic = Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).getSleepTimerFinishMusic();
        ...
        seekArcProgress = Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).getLastSleepTimerValue();
        ...
        seekArc.setOnSeekArcChangeListener(new SeekArc.OnSeekArcChangeListener() {
            ...
            public void onStopTrackingTouch(SeekArc seekArc) {
                Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setLastSleepTimerValue(seekArcProgress);
            }
        });
    ...
    private class TimerUpdater extends CountDownTimer {
        public TimerUpdater() {
            super(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).getNextSleepTimerElapsedRealTime() - SystemClock.elapsedRealtime(), 1000);
        }

        @Override
        public void onTick(long millisUntilFinished) {
            materialDialog.setActionButton(DialogAction.NEUTRAL, materialDialog.getContext().getString(R.string.cancel_current_timer) + " (" + Music_Player_Bass_MusicUtil.getReadableDurationString(millisUntilFinished) + ")");
        }

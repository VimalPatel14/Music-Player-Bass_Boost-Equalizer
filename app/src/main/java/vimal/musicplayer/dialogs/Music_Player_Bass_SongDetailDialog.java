...
public class Music_Player_Bass_SongDetailDialog extends DialogFragment {

    public static final String TAG = Music_Player_Bass_SongDetailDialog.class.getSimpleName();

    @NonNull
    public static Music_Player_Bass_SongDetailDialog create(Song song) {
        Music_Player_Bass_SongDetailDialog dialog = new Music_Player_Bass_SongDetailDialog();
        ...
        if (song != null) {
            ...
            if (songFile.exists()) {
                ...
                try {
                    ...
                    trackLength.setText(makeTextWithTitle(context, R.string.label_track_length, Music_Player_Bass_MusicUtil.getReadableDurationString(audioHeader.getTrackLength() * 1000)));
                    ...
                    // fallback
                    trackLength.setText(makeTextWithTitle(context, R.string.label_track_length, Music_Player_Bass_MusicUtil.getReadableDurationString(song.duration)));
                }
            } else {
                // fallback

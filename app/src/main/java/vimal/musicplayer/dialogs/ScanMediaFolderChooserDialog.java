...
public class ScanMediaFolderChooserDialog extends DialogFragment implements MaterialDialog.ListCallback {
    ...
    String initialPath = Music_Player_Bass_PreferenceUtil.getInstance(getContext()).getStartDirectory().getAbsolutePath();
        ...
        MaterialDialog.Builder builder =
                new MaterialDialog.Builder(getActivity())
                        ...
                        .onPositive((dialog, which) -> {
                            ...
                            dismiss();
                            new Music_Player_Bass_FoldersFragment.ListPathsAsyncTask(getActivity(), paths -> scanPaths(activityWeakReference, applicationContext, paths)).execute(new Music_Player_Bass_FoldersFragment.ListPathsAsyncTask.LoadingInfo(parentFolder, Music_Player_Bass_FoldersFragment.AUDIO_FILE_FILTER));
                        })

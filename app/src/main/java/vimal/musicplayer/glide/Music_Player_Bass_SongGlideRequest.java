...
public class Music_Player_Bass_SongGlideRequest {
    ...
    public static class Builder {
        ...
        public Builder checkIgnoreMediaStore(Context context) {
            return ignoreMediaStore(Music_Player_Bass_PreferenceUtil.getInstance(context).ignoreMediaStoreArtwork());
        }
    ...
    public static DrawableTypeRequest createBaseRequest(RequestManager requestManager, Song song, boolean ignoreMediaStore) {
        if (ignoreMediaStore) {
            ...
            return requestManager.loadFromMediaStore(Music_Player_Bass_MusicUtil.getMediaStoreAlbumCoverUri(song.albumId));
        }
    }

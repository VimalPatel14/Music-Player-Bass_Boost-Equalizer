package vimal.musicplayer.glide.palette;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap, BitmapPaletteWrapper> {
    ...
    public Resource<BitmapPaletteWrapper> transcode(Resource<Bitmap> bitmapResource) {
        ...
        BitmapPaletteWrapper bitmapPaletteWrapper = new BitmapPaletteWrapper(bitmap, Music_Player_Bass_PhonographColorUtil.generatePalette(bitmap));
        return new BitmapPaletteResource(bitmapPaletteWrapper, bitmapPool);
    }

    @Override
    public String getId() {
        return "BitmapPaletteTranscoder.photovideomusicstudio.GalleryPhotoMusicPlayer.glide.palette";
    }
}
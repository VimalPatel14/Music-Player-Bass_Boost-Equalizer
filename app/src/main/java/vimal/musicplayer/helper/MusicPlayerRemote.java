...
public class MusicPlayerRemote {
    ...
    public static void openQueue(final ArrayList<Song> queue, final int startPosition, final boolean startPlaying) {
        if (!tryToHandleOpenPlayingQueue(queue, startPosition, startPlaying) && musicService != null) {
            ...
            if (!Music_Player_Bass_PreferenceUtil.getInstance(musicService).rememberShuffle()){
        ...
        if (musicService != null) {
            ...
            if (uri.getScheme() != null && uri.getAuthority() != null) {
                if (uri.getScheme().equals(ContentResolver.SCHEME_CONTENT)) {
                    ...
                    if (songId != null) {
                        songs = Music_Player_Bass_SongLoader.getSongs(Music_Player_Bass_SongLoader.makeSongCursor(
                                musicService,

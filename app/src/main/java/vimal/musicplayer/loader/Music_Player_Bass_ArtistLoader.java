...
public class Music_Player_Bass_ArtistLoader {
    public static String getSongLoaderSortOrder(Context context) {
        return Music_Player_Bass_PreferenceUtil.getInstance(context).getArtistSortOrder() + ", " + Music_Player_Bass_PreferenceUtil.getInstance(context).getArtistAlbumSortOrder() + ", " + Music_Player_Bass_PreferenceUtil.getInstance(context).getAlbumSongSortOrder();
    }
    ...
    public static ArrayList<Artist> getAllArtists(@NonNull final Context context) {
        ...
        return splitIntoArtists(Music_Player_Bass_AlbumLoader.splitIntoAlbums(songs));
    }
    ...
    public static Artist getArtist(@NonNull final Context context, int artistId) {
        ...
        return new Artist(Music_Player_Bass_AlbumLoader.splitIntoAlbums(songs));
    }

...
public class Music_Player_Bass_GenreLoader {
    ...
    public static ArrayList<Song> getSongs(@NonNull final Context context, final int genreId) {
        return Music_Player_Bass_SongLoader.getSongs(makeGenreSongCursor(context, genreId));
    }
    ...
    private static Cursor makeGenreSongCursor(@NonNull final Context context, int genreId) {
        try {
            return context.getContentResolver().query(
                    ...
                    Music_Player_Bass_SongLoader.BASE_PROJECTION, Music_Player_Bass_SongLoader.BASE_SELECTION, null, Music_Player_Bass_PreferenceUtil.getInstance(context).getSongSortOrder());
    ...
    private static Cursor makeGenreCursor(@NonNull final Context context) {
        ...
        try {
            return context.getContentResolver().query(
                    ...
                    projection, null, null, Music_Player_Bass_PreferenceUtil.getInstance(context).getGenreSortOrder());
        } catch (SecurityException e) {
            return null;
        }
    }

...
public class Music_Player_Bass_SongLoader {
    ...
    public static Cursor makeSongCursor(@NonNull final Context context, @Nullable final String selection, final String[] selectionValues) {
        return makeSongCursor(context, selection, selectionValues, Music_Player_Bass_PreferenceUtil.getInstance(context).getSongSortOrder());
    }
    ...
    public static Cursor makeSongCursor(@NonNull final Context context, @Nullable String selection, String[] selectionValues, final String sortOrder) {
        ...
        // Blacklist
        ArrayList<String> paths = Music_Player_Bass_BlacklistStore.getInstance(context).getPaths();
        if (!paths.isEmpty()) {

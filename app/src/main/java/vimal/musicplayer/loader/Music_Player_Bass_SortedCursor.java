...
public class Music_Player_Bass_SortedCursor extends AbstractCursor {
    // cursor to wrap
     ...
     */
    public Music_Player_Bass_SortedCursor(@NonNull final Cursor cursor, @Nullable final String[] order, final String columnName) {
        mCursor = cursor;

...
public class Music_Player_Bass_SortedLongCursor extends AbstractCursor {
    // cursor to wrap
     ...
     */
    public Music_Player_Bass_SortedLongCursor(final Cursor cursor, final long[] order, final String columnName) {

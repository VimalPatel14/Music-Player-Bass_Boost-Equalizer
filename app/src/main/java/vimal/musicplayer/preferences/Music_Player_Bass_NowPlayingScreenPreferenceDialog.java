...
public class Music_Player_Bass_NowPlayingScreenPreferenceDialog extends DialogFragment implements MaterialDialog.SingleButtonCallback, ViewPager.OnPageChangeListener {

    private DialogAction whichButtonClicked;
    private int viewPagerPosition;

    public static Music_Player_Bass_NowPlayingScreenPreferenceDialog newInstance() {
        return new Music_Player_Bass_NowPlayingScreenPreferenceDialog();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        viewPager.setPageMargin((int) Music_Player_Bass_ViewUtil.convertDpToPixel(32, getResources()));
        viewPager.setCurrentItem(Music_Player_Bass_PreferenceUtil.getInstance(getContext()).getNowPlayingScreen().ordinal());
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        if (whichButtonClicked == DialogAction.POSITIVE) {
            Music_Player_Bass_PreferenceUtil.getInstance(getContext()).setNowPlayingScreen(NowPlayingScreen.values()[viewPagerPosition]);
        }
    }

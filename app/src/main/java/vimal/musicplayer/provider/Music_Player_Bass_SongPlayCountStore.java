...
public class Music_Player_Bass_SongPlayCountStore extends SQLiteOpenHelper {
    @Nullable
    private static Music_Player_Bass_SongPlayCountStore sInstance = null;
    ...
    public Music_Player_Bass_SongPlayCountStore(final Context context) {
     ...
     */
    @NonNull
    public static synchronized Music_Player_Bass_SongPlayCountStore getInstance(@NonNull final Context context) {
        if (sInstance == null) {
            sInstance = new Music_Player_Bass_SongPlayCountStore(context.getApplicationContext());
        }
        return sInstance;
    }

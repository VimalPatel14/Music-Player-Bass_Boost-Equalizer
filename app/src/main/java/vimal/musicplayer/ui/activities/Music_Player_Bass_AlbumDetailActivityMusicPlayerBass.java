...
import vimal.musicplayer.adapter.song.AlbumSongAdapter;
...
import vimal.musicplayer.lastfm.rest.model.LastFmAlbum;
...
import vimal.musicplayer.ui.activities.tageditor.AlbumTagEditorActivity;
...
public class Music_Player_Bass_AlbumDetailActivityMusicPlayerBass extends Music_Player_Bass_AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {
    ...
    private void setUpViews() {
        ...
        artistTextView.setOnClickListener(v -> {
            if (album != null) {
                Music_Player_Bass_NavigationUtil.goToArtist(Music_Player_Bass_AlbumDetailActivityMusicPlayerBass.this, album.getArtistId());
            }
        });
    ...
    private void loadAlbumCover() {
        Music_Player_Bass_SongGlideRequest.Builder.from(Glide.with(this), getAlbum().safeGetFirstSong())
                .checkIgnoreMediaStore(this)
                .generatePalette(this).build()
                .dontAnimate()
                .into(new Music_Player_Bass_PhonographColoredTarget(albumArtImageView) {
                    @Override
        ...
        lastFMRestClient.getApiService()
                ...
                .enqueue(new Callback<LastFmAlbum>() {
                    ...
                    public void onResponse(@NonNull Call<LastFmAlbum> call, @NonNull Response<LastFmAlbum> response) {
                        ...
                        if (!Music_Player_Bass_PreferenceUtil.isAllowedToDownloadMetadata(Music_Player_Bass_AlbumDetailActivityMusicPlayerBass.this)) {
                            if (wiki != null) {
                                wikiDialog.setContent(wiki);
                            } else {
                                wikiDialog.dismiss();
                                Toast.makeText(Music_Player_Bass_AlbumDetailActivityMusicPlayerBass.this, getResources().getString(R.string.wiki_unavailable), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_go_to_artist:
                Music_Player_Bass_NavigationUtil.goToArtist(this, getAlbum().getArtistId());
                return true;
    ...
    private void setAlbum(Album album) {
        ...
        songCountTextView.setText(Music_Player_Bass_MusicUtil.getSongCountString(this, album.getSongCount()));
        durationTextView.setText(Music_Player_Bass_MusicUtil.getReadableDurationString(Music_Player_Bass_MusicUtil.getTotalDuration(this, album.songs)));
        albumYearTextView.setText(Music_Player_Bass_MusicUtil.getYearString(album.getYear()));
    ...
    private static class AsyncAlbumLoader extends WrappedAsyncTaskLoader<Album> {
        ...
        public Album loadInBackground() {
            return Music_Player_Bass_AlbumLoader.getAlbum(getContext(), albumId);
        }
    }
}

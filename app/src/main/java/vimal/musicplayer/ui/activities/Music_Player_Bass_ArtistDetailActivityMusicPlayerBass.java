...
import vimal.musicplayer.adapter.album.HorizontalAlbumAdapter;
import vimal.musicplayer.adapter.song.ArtistSongAdapter;
...
import vimal.musicplayer.misc.SimpleObservableScrollViewCallbacks;
...
public class Music_Player_Bass_ArtistDetailActivityMusicPlayerBass extends Music_Player_Bass_AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usePalette = Music_Player_Bass_PreferenceUtil.getInstance(this).albumArtistColoredFooters();
    ...
    protected void setUsePalette(boolean usePalette) {
        ...
        Music_Player_Bass_PreferenceUtil.getInstance(this).setAlbumArtistColoredFooters(usePalette);
        ...
        lastFMRestClient.getApiService()
                ...
                .enqueue(new Callback<LastFmArtist>() {
                    ...
                    public void onResponse(@NonNull Call<LastFmArtist> call, @NonNull Response<LastFmArtist> response) {
                        ...
                        if (!Music_Player_Bass_PreferenceUtil.isAllowedToDownloadMetadata(Music_Player_Bass_ArtistDetailActivityMusicPlayerBass.this)) {
                            if (biography != null) {
                                biographyDialog.setContent(biography);
                            } else {
                                biographyDialog.dismiss();
                                Toast.makeText(Music_Player_Bass_ArtistDetailActivityMusicPlayerBass.this, getResources().getString(R.string.biography_unavailable), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
    ...
    private void loadArtistImage() {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
                ...
                .dontAnimate()
                .into(new Music_Player_Bass_PhonographColoredTarget(artistImage) {
                    @Override
        ...
        switch (requestCode) {
            case REQUEST_CODE_SELECT_IMAGE:
                if (resultCode == RESULT_OK) {
                    Music_Player_Bass_CustomArtistImageUtil.getInstance(this).setCustomArtistImage(artist, data.getData());
                }
                break;
            default:
                if (resultCode == RESULT_OK) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_equalizer:
                Music_Player_Bass_NavigationUtil.openEqualizer(this);
                return true;
            ...
            case R.id.action_add_to_playlist:
                Music_Player_Bass_AddToPlaylistDialog.create(songs).show(getSupportFragmentManager(), "ADD_PLAYLIST");
                return true;
            ...
            case R.id.action_biography:
                ...
                if (Music_Player_Bass_PreferenceUtil.isAllowedToDownloadMetadata(Music_Player_Bass_ArtistDetailActivityMusicPlayerBass.this)) { // wiki should've been already downloaded
                    if (biography != null) {
                        biographyDialog.setContent(biography);
            ...
            case R.id.action_reset_artist_image:
                Toast.makeText(Music_Player_Bass_ArtistDetailActivityMusicPlayerBass.this, getResources().getString(R.string.updating), Toast.LENGTH_SHORT).show();
                Music_Player_Bass_CustomArtistImageUtil.getInstance(Music_Player_Bass_ArtistDetailActivityMusicPlayerBass.this).resetCustomArtistImage(artist);
                forceDownload = true;
                return true;
    ...
    public MaterialCab openCab(int menuRes, @NonNull final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, R.id.cab_stub)
                ...
                .setBackgroundColor(Music_Player_Bass_PhonographColorUtil.shiftBackgroundColorForLightText(getPaletteColor()))
    ...
    private void setArtist(Artist artist) {
        ...
        if (Music_Player_Bass_PreferenceUtil.isAllowedToDownloadMetadata(this)) {
            loadBiography();
        }

        getSupportActionBar().setTitle(artist.getName());
        songCountTextView.setText(Music_Player_Bass_MusicUtil.getSongCountString(this, artist.getSongCount()));
        albumCountTextView.setText(Music_Player_Bass_MusicUtil.getAlbumCountString(this, artist.getAlbumCount()));
        durationTextView.setText(Music_Player_Bass_MusicUtil.getReadableDurationString(Music_Player_Bass_MusicUtil.getTotalDuration(this, artist.getSongs())));
    ...
    private static class AsyncArtistDataLoader extends WrappedAsyncTaskLoader<Artist> {
        ...
        public Artist loadInBackground() {
            return Music_Player_Bass_ArtistLoader.getArtist(getContext(), artistId);
        }
    }
}

...
public class Music_Player_Bass_GenreDetailActivityMusicPlayerBass extends Music_Player_Bass_AbsSlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<ArrayList<Song>> {
    ...
    public Loader<ArrayList<Song>> onCreateLoader(int id, Bundle args) {
        return new Music_Player_Bass_GenreDetailActivityMusicPlayerBass.AsyncGenreSongLoader(this, genre);
    }
    ...
    private static class AsyncGenreSongLoader extends WrappedAsyncTaskLoader<ArrayList<Song>> {
        ...
        public ArrayList<Song> loadInBackground() {
            return Music_Player_Bass_GenreLoader.getSongs(getContext(), genre.id);
        }
    }
}

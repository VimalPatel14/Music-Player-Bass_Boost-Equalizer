...
import vimal.musicplayer.preferences.Music_Player_Bass_BlacklistPreference;
import vimal.musicplayer.preferences.Music_Player_Bass_BlacklistPreferenceDialog;
import vimal.musicplayer.preferences.Music_Player_Bass_LibraryPreference;
import vimal.musicplayer.preferences.Music_Player_Bass_LibraryPreferenceDialog;
import vimal.musicplayer.preferences.Music_Player_Bass_NowPlayingScreenPreference;
import vimal.musicplayer.preferences.Music_Player_Bass_NowPlayingScreenPreferenceDialog;
...
public class Music_Player_Bass_SettingsActivity extends AbsBaseActivity implements ColorChooserDialog.ColorCallback {
...
//                        startActivity(new Intent(this, Music_Player_Bass_PurchaseActivity.class));
//                        return;
//                    }
//                }
...
//            addPreferencesFromResource(R.xml.pref_blacklist);
        ...
        public DialogFragment onCreatePreferenceDialog(Preference preference) {
            if (preference instanceof Music_Player_Bass_NowPlayingScreenPreference) {
                return Music_Player_Bass_NowPlayingScreenPreferenceDialog.newInstance();
            } else if (preference instanceof Music_Player_Bass_BlacklistPreference) {
                return Music_Player_Bass_BlacklistPreferenceDialog.newInstance();
            } else if (preference instanceof Music_Player_Bass_LibraryPreference) {
                return Music_Player_Bass_LibraryPreferenceDialog.newInstance();
            }
...
//                    startActivity(new Intent(getContext(), Music_Player_Bass_PurchaseActivity.class));
                    return false;
                }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
                    ...
                    getActivity().setTheme(Music_Player_Bass_PreferenceUtil.getThemeResFromPrefValue(themeName));
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
                ...
                classicNotification.setChecked(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).classicNotification());
                classicNotification.setOnPreferenceChangeListener((preference, newValue) -> {
                    // Save preference
                    Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setClassicNotification((Boolean) newValue);
                    return true;
                });
            }
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                coloredNotification.setEnabled(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).classicNotification());
            } else {
                coloredNotification.setChecked(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).coloredNotification());
                coloredNotification.setOnPreferenceChangeListener((preference, newValue) -> {
                    // Save preference
                    Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setColoredNotification((Boolean) newValue);
                    return true;
                });
            }
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                colorAppShortcuts.setChecked(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).coloredAppShortcuts());
                colorAppShortcuts.setOnPreferenceChangeListener((preference, newValue) -> {
                    // Save preference
                    Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).setColoredAppShortcuts((Boolean) newValue);
...
//            updateNowPlayingScreenSummary();
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            switch (key) {
                case Music_Player_Bass_PreferenceUtil.NOW_PLAYING_SCREEN_ID:
                    updateNowPlayingScreenSummary();
                    break;
        ...
        private void updateNowPlayingScreenSummary() {
            findPreference("now_playing_screen_id").setSummary(Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).getNowPlayingScreen().titleRes);
        }
    }
}

package vimal.musicplayer.ui.activities.tageditor;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, Music_Player_Bass_PhonographColorUtil.getColor(Music_Player_Bass_PhonographColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, R.attr.defaultFooterColor)));
        ...
        lastFMRestClient.getApiService().getAlbumInfo(albumTitleStr, albumArtistNameStr, null).enqueue(new Callback<LastFmAlbum>() {
            ...
            public void onResponse(Call<LastFmAlbum> call, Response<LastFmAlbum> response) {
                ...
                if (lastFmAlbum.getAlbum() != null) {
                    String url = Music_Player_Bass_LastFMUtil.getLargestAlbumImageUrl(lastFmAlbum.getAlbum().getImage());
                        ...
                        Glide.with(AlbumTagEditorActivity.this)
                                ...
                                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                                    ...
                                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                                        albumArtBitmap = Music_Player_Bass_ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                                        setImageBitmap(albumArtBitmap, Music_Player_Bass_PhonographColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                                        deleteAlbumArt = false;
                                        dataChanged();
                                        setResult(RESULT_OK);
                                    }
    ...
    protected List<String> getSongPaths() {
        ArrayList<Song> songs = Music_Player_Bass_AlbumLoader.getAlbum(this, getId()).songs;
    ...
    protected void loadImageFromFile(@NonNull final Uri selectedFileUri) {
        Glide.with(AlbumTagEditorActivity.this)
                ...
                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                    ...
                    @Override
                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                        Music_Player_Bass_PhonographColorUtil.getColor(resource.getPalette(), Color.TRANSPARENT);
                        albumArtBitmap = Music_Player_Bass_ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                        setImageBitmap(albumArtBitmap, Music_Player_Bass_PhonographColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                        deleteAlbumArt = false;
                        dataChanged();

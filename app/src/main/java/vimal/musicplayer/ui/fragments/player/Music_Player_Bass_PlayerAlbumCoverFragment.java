...
import vimal.musicplayer.adapter.AlbumCoverPagerAdapter;
import vimal.musicplayer.helper.MusicPlayerRemote;
import vimal.musicplayer.helper.MusicProgressViewUpdateHelper;
import vimal.musicplayer.misc.SimpleAnimatorListener;
import vimal.musicplayer.model.lyrics.Music_Player_Bass_AbsSynchronizedLyrics;
 ...
 */
public class Music_Player_Bass_PlayerAlbumCoverFragment extends AbsMusicServiceFragment implements ViewPager.OnPageChangeListener, MusicProgressViewUpdateHelper.Callback {
...
//        adContainer.bringToFront();
    ...
    public void showHeartAnimation() {
        ...
        favoriteIcon.animate()
                .setDuration(Music_Player_Bass_ViewUtil.PHONOGRAPH_ANIM_TIME / 2)
    ...
    private boolean isLyricsLayoutVisible() {
        return lyrics != null && lyrics.isSynchronized() && lyrics.isValid() && Music_Player_Bass_PreferenceUtil.getInstance(getActivity()).synchronizedLyricsShow();
    }
    ...
    private void hideLyricsLayout() {
        lyricsLayout.animate().alpha(0f).setDuration(Music_Player_Bass_PlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION).withEndAction(() -> {
    ...
    public void setLyrics(Lyrics l) {
        ...
        lyricsLayout.animate().alpha(1f).setDuration(Music_Player_Bass_PlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);
    }
    ...
    public void onUpdateProgressViews(int progress, int total) {
        ...
        if (!(lyrics instanceof Music_Player_Bass_AbsSynchronizedLyrics)) return;
        Music_Player_Bass_AbsSynchronizedLyrics synchronizedLyrics = (Music_Player_Bass_AbsSynchronizedLyrics) lyrics;
        ...
        if (!oldLine.equals(line) || oldLine.isEmpty()) {
            ...
            lyricsLine1.animate().alpha(0f).translationY(-h).setDuration(Music_Player_Bass_PlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);

            lyricsLine2.setAlpha(0f);
            lyricsLine2.setTranslationY(h);
            lyricsLine2.animate().alpha(1f).translationY(0f).setDuration(Music_Player_Bass_PlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);
        }
    }

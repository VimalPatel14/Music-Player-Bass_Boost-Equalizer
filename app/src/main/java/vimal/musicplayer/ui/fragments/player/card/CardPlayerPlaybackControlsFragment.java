...
import vimal.musicplayer.helper.Music_Player_Bass_PlayPauseButtonOnClickHandler;
import vimal.musicplayer.misc.SimpleOnSeekbarChangeListener;
...
import vimal.musicplayer.views.Music_Player_Bass_PlayPauseDrawable;
...
public class CardPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    private Music_Player_Bass_PlayPauseDrawable playerFabMusicPlayerBassPlayPauseDrawable;
    ...
    private void setUpPlayPauseFab() {
        ...
        playerFabMusicPlayerBassPlayPauseDrawable = new Music_Player_Bass_PlayPauseDrawable(getActivity());

        playPauseFab.setImageDrawable(playerFabMusicPlayerBassPlayPauseDrawable); // Note: set the drawable AFTER TintHelper.setTintAuto() was called
        ...
        playPauseFab.setOnClickListener(new Music_Player_Bass_PlayPauseButtonOnClickHandler());
        playPauseFab.post(() -> {
    ...
    protected void updatePlayPauseDrawableState(boolean animate) {
        if (MusicPlayerRemote.isPlaying()) {
            playerFabMusicPlayerBassPlayPauseDrawable.setPause(animate);
        } else {
            playerFabMusicPlayerBassPlayPauseDrawable.setPlay(animate);
        }
    }
    ...
    public void onUpdateProgressViews(int progress, int total) {
        ...
        songTotalTime.setText(Music_Player_Bass_MusicUtil.getReadableDurationString(total));
        songCurrentProgress.setText(Music_Player_Bass_MusicUtil.getReadableDurationString(progress));
    }
}

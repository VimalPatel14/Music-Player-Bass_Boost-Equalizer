package vimal.musicplayer.ui.fragments.player.flat;
...
public class FlatPlayerFragmentMusicPlayerBass extends Music_Player_Bass_AbsPlayerFragment implements Music_Player_Bass_PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static abstract class BaseImpl implements Impl {
        protected FlatPlayerFragmentMusicPlayerBass fragment;

        public BaseImpl(FlatPlayerFragmentMusicPlayerBass fragment) {
            this.fragment = fragment;
        }

        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            Animator backgroundAnimator = Music_Player_Bass_ViewUtil.createBackgroundColorTransition(fragment.playbackControlsFragment.getView(), fragment.lastColor, newColor);
            Animator statusBarAnimator = Music_Player_Bass_ViewUtil.createBackgroundColorTransition(fragment.playerStatusBar, fragment.lastColor, newColor);
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public PortraitImpl(FlatPlayerFragmentMusicPlayerBass fragment) {
            super(fragment);
        }
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            final int minPanelHeight = (int) Music_Player_Bass_ViewUtil.convertDpToPixel(8 + 72 + 24, fragment.getResources()) + fragment.getResources().getDimensionPixelSize(R.dimen.progress_container_height) + fragment.getResources().getDimensionPixelSize(R.dimen.media_controller_container_height);
    ...
    private static class LandscapeImpl extends BaseImpl {
        public LandscapeImpl(FlatPlayerFragmentMusicPlayerBass fragment) {
            super(fragment);
        }
        ...
        @Override
        public void setUpPanelAndAlbumCoverHeight() {
            ((Music_Player_Bass_AbsSlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.getView().findViewById(R.id.player_panel));
        }

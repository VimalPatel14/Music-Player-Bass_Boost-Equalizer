...
public class FlatPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    private Music_Player_Bass_PlayPauseDrawable musicPlayerBassPlayPauseDrawable;
    ...
    private void setUpPlayPauseButton() {
        musicPlayerBassPlayPauseDrawable = new Music_Player_Bass_PlayPauseDrawable(getActivity());
        playPauseButton.setImageDrawable(musicPlayerBassPlayPauseDrawable);
        updatePlayPauseColor();
        playPauseButton.setOnClickListener(new Music_Player_Bass_PlayPauseButtonOnClickHandler());
    ...
    protected void updatePlayPauseDrawableState(boolean animate) {
        if (MusicPlayerRemote.isPlaying()) {
            musicPlayerBassPlayPauseDrawable.setPause(animate);
        } else {
            musicPlayerBassPlayPauseDrawable.setPlay(animate);
        }
    }

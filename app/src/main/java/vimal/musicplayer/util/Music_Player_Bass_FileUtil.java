...
import vimal.musicplayer.loader.Music_Player_Bass_SortedCursor;
...
public final class Music_Player_Bass_FileUtil {
    private Music_Player_Bass_FileUtil() {
    }

    @NonNull
    public static ArrayList<Song> matchFilesWithMediaStore(@NonNull Context context, @Nullable List<File> files) {
        return Music_Player_Bass_SongLoader.getSongs(makeSongCursor(context, files));
    }

    @Nullable
    public static Music_Player_Bass_SortedCursor makeSongCursor(@NonNull final Context context, @Nullable final List<File> files) {
        ...
        Cursor songCursor = Music_Player_Bass_SongLoader.makeSongCursor(context, selection, selection == null ? null : paths);

        return songCursor == null ? null : new Music_Player_Bass_SortedCursor(songCursor, paths, MediaStore.Audio.AudioColumns.DATA);
    }

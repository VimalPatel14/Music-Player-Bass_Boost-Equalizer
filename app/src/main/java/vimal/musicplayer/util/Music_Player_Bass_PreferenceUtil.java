...
public final class Music_Player_Bass_PreferenceUtil {
    ...
    private static Music_Player_Bass_PreferenceUtil sInstance;

    private final SharedPreferences mPreferences;

    private Music_Player_Bass_PreferenceUtil(@NonNull final Context context) {
        mPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    }

    public static Music_Player_Bass_PreferenceUtil getInstance(@NonNull final Context context) {
        if (sInstance == null) {
            sInstance = new Music_Player_Bass_PreferenceUtil(context.getApplicationContext());
        }
        return sInstance;
    }
    ...
    public final String getArtistSortOrder() {
        return mPreferences.getString(ARTIST_SORT_ORDER, Music_Player_Bass_SortOrder.ArtistSortOrder.ARTIST_A_Z);
    }
    ...
    public final String getArtistSongSortOrder() {
        return mPreferences.getString(ARTIST_SONG_SORT_ORDER, Music_Player_Bass_SortOrder.ArtistSongSortOrder.SONG_A_Z);
    }

    public final String getArtistAlbumSortOrder() {
        return mPreferences.getString(ARTIST_ALBUM_SORT_ORDER, Music_Player_Bass_SortOrder.ArtistAlbumSortOrder.ALBUM_YEAR);
    }

    public final String getAlbumSortOrder() {
        return mPreferences.getString(ALBUM_SORT_ORDER, Music_Player_Bass_SortOrder.AlbumSortOrder.ALBUM_A_Z);
    }
    ...
    public final String getAlbumSongSortOrder() {
        return mPreferences.getString(ALBUM_SONG_SORT_ORDER, Music_Player_Bass_SortOrder.AlbumSongSortOrder.SONG_TRACK_LIST);
    }

    public final String getSongSortOrder() {
        return mPreferences.getString(SONG_SORT_ORDER, Music_Player_Bass_SortOrder.SongSortOrder.SONG_A_Z);
    }
    ...
    public final String getGenreSortOrder() {
        return mPreferences.getString(GENRE_SORT_ORDER, Music_Player_Bass_SortOrder.GenreSortOrder.GENRE_A_Z);
    }
    ...
    private long getCutoffTimeMillis(final String cutoff) {
        final Music_Player_Bass_CalendarUtil musicPlayerBassCalendarUtil = new Music_Player_Bass_CalendarUtil();
        long interval;

        switch (mPreferences.getString(cutoff, "")) {
            case "today":
                interval = musicPlayerBassCalendarUtil.getElapsedToday();
                break;

            case "this_week":
                interval = musicPlayerBassCalendarUtil.getElapsedWeek();
                break;

             case "past_seven_days":
                interval = musicPlayerBassCalendarUtil.getElapsedDays(7);
                break;

            case "past_three_months":
                interval = musicPlayerBassCalendarUtil.getElapsedMonths(3);
                break;

            case "this_year":
                interval = musicPlayerBassCalendarUtil.getElapsedYear();
                break;

            case "this_month":
            default:
                interval = musicPlayerBassCalendarUtil.getElapsedMonth();
                break;
        }
    ...
    public final File getStartDirectory() {
        return new File(mPreferences.getString(START_DIRECTORY, Music_Player_Bass_FoldersFragment.getDefaultStartDirectory().getPath()));
    }

    public void setStartDirectory(File file) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(START_DIRECTORY, Music_Player_Bass_FileUtil.safeGetCanonicalPath(file));
        editor.apply();
    }

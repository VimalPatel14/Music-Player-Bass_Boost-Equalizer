...
public class Music_Player_Bass_BreadCrumbLayout extends HorizontalScrollView implements View.OnClickListener {
    ...
    public Music_Player_Bass_BreadCrumbLayout(Context context) {
        super(context);
        init();
    }

    public Music_Player_Bass_BreadCrumbLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Music_Player_Bass_BreadCrumbLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class SavedStateWrapper implements Parcelable {
        ...
        public SavedStateWrapper(Music_Player_Bass_BreadCrumbLayout view) {

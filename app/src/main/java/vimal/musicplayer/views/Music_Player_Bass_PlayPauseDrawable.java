...
public class Music_Player_Bass_PlayPauseDrawable extends Drawable {
    private static final long PLAY_PAUSE_ANIMATION_DURATION = 250;

    private static final Property<Music_Player_Bass_PlayPauseDrawable, Float> PROGRESS =
            new Property<Music_Player_Bass_PlayPauseDrawable, Float>(Float.class, "progress") {
                @Override
                public Float get(@NonNull Music_Player_Bass_PlayPauseDrawable d) {
                    return d.getProgress();
                }

                @Override
                public void set(@NonNull Music_Player_Bass_PlayPauseDrawable d, Float value) {
                    d.setProgress(value);
                }
            };
    ...
    public Music_Player_Bass_PlayPauseDrawable(@NonNull Context context) {
